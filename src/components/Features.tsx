...
const Features = () => {
  const features = [
    {
      ...
      description:
        "Upload any bill photo — we'll extract every detail accurately with AI-powered recognition",
      icon: Camera,
    ...
    },
    {
      ...
      description:
        "Type 'coffee 120' or 'refund zomato 450' — our AI understands natural language perfectly",
      icon: Brain,
    ...
    },
    {
      ...
      description:
        "Say 'split dinner 2400 with raj priya' — everyone gets instant WhatsApp notifications",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "End-to-end encryption, zero data selling, complete privacy protection for your finances",
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "Get personalized spending patterns, budget alerts, and financial insights automatically",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "Understands Hindi, English, regional languages and local expense patterns seamlessly",
      icon: Star,
  ...
  return (
    <section
      className="relative py-28 bg-gradient-to-br from-background to-muted/30 overflow-hidden"
      id="features"
    >
      {/* Background elements */}
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br ${feature.gradient} mb-8 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-glow`}
                  >
        ...
        <div className="space-y-16">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              See why thousands are switching from spreadsheets and apps to
              Hisaab
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-10 bg-gradient-to-br from-red-50 to-red-100 rounded-3xl border-2 border-red-200 relative overflow-hidden hover-lift">
              ...
              <div className="text-center space-y-8">
                ...
                <h4 className="font-black text-red-700 text-2xl font-heading">
                  Excel Sheets
                </h4>
            ...
            <div className="p-10 bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl border-2 border-orange-200 relative overflow-hidden hover-lift">
              ...
              <div className="text-center space-y-8">
                ...
                <h4 className="font-black text-orange-700 text-2xl font-heading">
                  Expense Apps
                </h4>
            ...
            <div className="relative p-10 rounded-3xl border-2 border-teal/30 overflow-hidden hover-lift bg-gradient-to-br from-teal/5 via-lime/5 to-purple/5">
              ...
              <div className="relative text-center space-y-8 pt-6">
                ...
                <h4 className="font-black text-3xl font-heading text-gradient bg-clip-text">
                  WhatsApp Only
                </h4>
