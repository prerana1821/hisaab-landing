        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="space-y-10 animate-bounce-in">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-heading font-black text-foreground leading-[0.9] tracking-tight">
                Your expenses.{" "}
                <span className="text-gradient-rainbow bg-clip-text">One WhatsApp message</span>{" "}
                away.
              </h1>
              
              <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-xl font-medium">
                Send a bill photo or type{" "}
                <span className="font-mono bg-muted px-2 py-1 rounded text-foreground">'coffee 120'</span>
            ...
            <div className="space-y-4 pt-6">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <a href="#privacy" className="text-teal hover:underline font-medium ml-1">
                  Full privacy policy
                </a>
              </div>
            </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative group">
              ...
              <div className="absolute -bottom-8 -left-8 w-20 h-20 glass-effect rounded-full flex items-center justify-center animate-float border border-white/30" style={{animationDelay: '1.5s'}}>
                <Shield className="w-10 h-10 text-teal" />
              </div>
              
              <div className="absolute top-1/2 -right-12 w-12 h-12 bg-gradient-to-br from-purple to-pink rounded-full flex items-center justify-center animate-float opacity-80" style={{animationDelay: '0.8s'}}>
