...
const Demo = () => {
  const demoMessages = [
    ...
    },
    {
      ...
      response:
        "✅ Logged: Uber ₹340 (Transport) - Home to Office - Today 9:15 AM",
      goal: "personal",
    },
    {
      message: "split dinner 2400 with raj priya",
      response:
        "✅ Split logged: Dinner ₹2400 ÷ 3 = ₹800 each\n📱 Notified Raj & Priya on WhatsApp",
      goal: "split",
    },
    {
      message: "refund zomato 450",
      response:
        "✅ Refund processed: Zomato -₹450 (Food & Drinks) - Today 7:45 PM",
      goal: "personal",
    },
  ];
      ...
      <div className="container relative z-10">
        <div className="text-center space-y-6 mb-20">
          ...
          <h2 className="text-4xl lg:text-6xl font-heading font-black text-foreground">
            See it in{" "}
            <span className="text-gradient-rainbow bg-clip-text">action</span>
          </h2>
          ...
          <div className="relative inline-block">
            ...
            <Button
              ...
              onClick={() => {
                ...
                window.open(
                  `https://wa.me/14155238886?text=${message}`,
                  "_blank",
                );
              }}
