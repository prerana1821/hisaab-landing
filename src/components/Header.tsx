        ...
        <div className="flex items-center space-x-2">
          <div className="flex items-center space-x-4">
            ...
            <div className="space-y-1">
              <span className="font-heading font-black text-3xl text-gradient bg-clip-text">Hisaab</span>
              <div className="text-xs font-mono text-muted-foreground tracking-wide">AI • WhatsApp • India</div>
            </div>
          </div>
        </div>
        
        <nav className="hidden md:flex items-center space-x-10">
          <a href="#features" className="text-sm font-semibold text-muted-foreground hover:text-teal transition-all duration-300 hover:scale-105 relative group">
            Features
          ...
          <a href="#demo" className="text-sm font-semibold text-muted-foreground hover:text-teal transition-all duration-300 hover:scale-105 relative group">
            Demo
            <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-teal to-lime transition-all duration-300 group-hover:w-full"></div>
          </a>
          <a href="#privacy" className="text-sm font-semibold text-muted-foreground hover:text-teal transition-all duration-300 hover:scale-105 relative group">
            Privacy
            <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-teal to-lime transition-all duration-300 group-hover:w-full"></div>
          </a>
        </nav>
